...
- Open your app's App_Resources/iOS folder and [add this](https://github.com/EddyVerbruggen/nativescript-apple-sign-in/demo/app/App_Resources/iOS/app.entitlements) (or append) to a file named `app.entitlements`. 
